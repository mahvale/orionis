                           ...
                           <img src="/images/course/cu-1.jpg" class="card-img-top" alt="Course">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    <div class="d-flex chapterRating" data-chapterRating="{{$tp->id}}">

                                    </div>
                                    <span class="reviewCount" data-chapterRating="{{$tp->id}}">&nbsp;&nbsp;(20 Avis)</span>
                                </div>
                                <p class="card-text">description </p>

                                <div style="display:flex;">
                                     @foreach ($tp->materialtps as $material)
                            ...
                            <div class="d-flex align-items-center">
                                <div class="rating ml-2" data-tp-id="{{$tp->id}}">
                                ...
                                <button data-chatId="{{$tp->id}}" class="btn btn-link submitRating" style="font-family: Times New Roman;">avis</button>
                            </div>
                        </div>
                    </div>
