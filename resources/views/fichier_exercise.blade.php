...
<div class="container">
	<div class="d-flex justify-content-center flex-row">
		 <h4 class="text-center mt-2 mb-2 mr-4" style="font-family: Felix Titling;"> {{$title}} </h4>
		 	@if($exercices->corrections->isNotEmpty())
		    <h4 class="text-center mt-2 mb-2" style="font-family: Felix Titling;"> <a href="/fichier2/{{$file}}/{{$exercices->corrections->first()->file}}" class="btn btn-outline-primary" >correction</a>  </h4>
		     @endif
	</div>
...
<script>
    ...
    const url = `/uploads/materials/{{$file}}`;  // Chemin vers votre fichier PDF
