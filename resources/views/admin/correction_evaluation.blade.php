        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editExerciseModal{{ $correction->id }}">
                     ...
                     <form action="{{ route('corrections_evaluations.destroy', $correction->id) }}" method="POST" style="display:inline-block;">
                        @csrf
                        @method('DELETE')
            ...
            <div class="modal fade" id="editExerciseModal{{ $correction->id }}" tabindex="-1" aria-labelledby="editExerciseModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('corrections_evaluations.update', $correction->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
             ...
             @empty
                    ...
                    <div>
                        <p style="font-family: Times New Roman;">Aucune Correction disponible  </p>
                    </div>
...
<div class="modal fade" id="addExerciseModal" tabindex="-1" aria-labelledby="addExerciseModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('corrections_evaluations.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        <label for="exercises">Evaluations</label>
